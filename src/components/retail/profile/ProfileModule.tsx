...
import { MyActivityScreen, TransactionLimitsScreen } from './screens/ActivityLimitsScreens';
import {
  NotificationsScreen,
  PrivacyScreen,
...
export const ProfileModule: React.FC = () => {
  ...
  const screens: Record<string, React.ReactNode> = {
    ...
    'freeze-account': <FreezeAccountScreen {...props} />,
    ...
    'change-tpin': <ChangeTpinScreen {...props} />,
    ...
    'my-activity': <MyActivityScreen {...props} />,
    'transaction-limits': <TransactionLimitsScreen {...props} />,
