...
export const StickyBillCTA: React.FC<{
  ...
  <div className="fixed bottom-0 left-0 right-0 z-30 p-4 bg-linear-to-tr from-slate-50 via-slate-50/95 to-transparent dark:from-slate-950 dark:via-slate-950/95 max-w-lg mx-auto">
    <button
      type="button"
      disabled={disabled}
      onClick={onClick}
