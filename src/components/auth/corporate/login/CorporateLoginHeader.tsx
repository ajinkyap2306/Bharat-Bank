    ...
    <div className="flex items-start justify-between gap-3">
      <div className="flex items-center gap-2.5 min-w-0">
        ...
        <div className="min-w-0">
          <h1 className="text-[15px] font-semibold text-[#111827] dark:text-white leading-tight tracking-tight">
            Corporate Banking
          </h1>
          <div className="flex items-center gap-1 mt-0.5">
            <ShieldCheck className="w-3 h-3 text-[#16A34A] shrink-0" aria-hidden />
            <p className="text-[11px] text-[#667085] dark:text-slate-400 leading-snug truncate">
      ...
      <button
        ...
        aria-label="Help"
      >
        <HelpCircle className="w-4.5 h-4.5 text-[#667085]" />
      </button>
    </div>
  </header>
);
