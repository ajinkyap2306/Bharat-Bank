  ...
  <div className="mx-4 p-4 rounded-2xl bg-white dark:bg-slate-900 border border-[#E4E7EC] dark:border-slate-800 shadow-sm">
    <div className="flex items-start justify-between gap-3">
      <div className="flex items-start gap-3 min-w-0">
        <div className="w-10 h-10 rounded-xl bg-congress-blue-700/8 flex items-center justify-center shrink-0">
          <Fingerprint className="w-4.5 h-4.5 text-congress-blue-700" aria-hidden />
        </div>
      ...
      <button
        ...
        className={`relative w-11 h-6 rounded-full transition-colors duration-200 shrink-0 min-h-11 min-w-11 flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-congress-blue-700/30 ${
          enabled ? 'bg-congress-blue-700' : 'bg-[#E4E7EC] dark:bg-slate-700'
