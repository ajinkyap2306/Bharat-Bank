...
export const BiometricPrompt: React.FC<BiometricPromptProps> = ({ visible }) => {
  ...
  return (
    <div
      className="mx-4 mt-4 p-4 rounded-2xl bg-[#F7F9FC] dark:bg-slate-800/50 border border-[#E4E7EC] dark:border-slate-700"
      role="region"
    ...
    >
      ...
      <p className="text-[13px] text-[#667085] dark:text-slate-400 mt-1">
