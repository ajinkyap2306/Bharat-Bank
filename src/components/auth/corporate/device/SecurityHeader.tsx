  ...
  <header className="px-4 pt-3 pb-2 safe-top">
    <div className="flex items-center gap-2 min-h-11">
      <button
        type="button"
        onClick={onBack}
        className="w-11 h-11 -ml-2 flex items-center justify-center rounded-xl text-slate-900 dark:text-white active:scale-95 transition-transform motion-reduce:transition-none"
        aria-label="Go back"
      >
