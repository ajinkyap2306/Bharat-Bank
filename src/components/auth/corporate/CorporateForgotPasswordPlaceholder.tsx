...
/** Placeholder route — full forgot-password flow will be implemented in a later step. */
export const CorporateForgotPasswordPlaceholder: React.FC = () => {
    ...
    <div className="min-h-dvh bg-slate-50 dark:bg-slate-950 flex flex-col safe-top safe-bottom max-w-107.5 mx-auto w-full">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        <div className="w-14 h-14 rounded-2xl bg-congress-blue-700/10 flex items-center justify-center mb-4">
          <KeyRound className="w-7 h-7 text-congress-blue-700" />
        </div>
        <h1 className="text-xl font-semibold text-slate-900 dark:text-white">
          Forgot Password
        </h1>
        <p className="text-[14px] text-slate-500 mt-2 max-w-xs leading-relaxed">
          Password recovery for corporate accounts will be available in a future step.
        </p>
      </div>
    </div>
  );
