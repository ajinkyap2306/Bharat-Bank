...
export const TransactionBalanceSummary: React.FC<TransactionBalanceSummaryProps> = ({
  ...
  return (
    <div className="mx-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-3.5 shadow-sm">
      <div className="flex items-start justify-between gap-3">
        <div className="flex gap-6">
          <div>
            <p className="text-[11px] text-slate-500 dark:text-slate-400">Available Balance</p>
            <p className="text-[18px] font-semibold text-slate-900 dark:text-white tabular-nums mt-0.5">
