    ...
    <div className="flex items-center justify-between gap-2">
      <div className="flex items-center gap-1 min-w-0 flex-1">
        ...
        <div className="min-w-0">
          <h1 className="text-[17px] font-bold text-slate-900 dark:text-white truncate">{title}</h1>
          {subtitle && <p className="text-[12px] text-slate-500 dark:text-slate-400 font-mono truncate">{subtitle}</p>}
        </div>
      </div>
      <button
        type="button"
