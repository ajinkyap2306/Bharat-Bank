...
export const TransactionAmountCard: React.FC<TransactionAmountCardProps> = ({
  ...
  return (
    <div className="mx-4 rounded-2xl bg-white dark:bg-slate-900 border border-[#E4E7EC] dark:border-slate-800 p-4 shadow-sm space-y-3">
      <div className="flex items-center justify-between gap-3 pb-3 border-b border-[#E4E7EC]/80 dark:border-slate-800">
        <div>
          <p className="text-[12px] text-[#667085]">Amount</p>
          <p className="text-[20px] font-semibold text-[#111827] dark:text-white tabular-nums mt-0.5">
            {mask(formatAccountCurrency(details.amount, details.currency))}
          </p>
        </div>
        <div className="text-right">
          <p className="text-[12px] text-[#667085]">Currency</p>
          <p className="text-[14px] font-semibold text-[#111827] dark:text-white mt-0.5">
      ...
      {details.fee > 0 && (
        <>
          <div className="flex items-center justify-between">
            <span className="text-[13px] text-[#667085]">Transaction Fee</span>
            <span className="text-[14px] font-medium text-[#111827] dark:text-white tabular-nums">
      ...
      <div className="flex items-center gap-3 pt-2 border-t border-[#E4E7EC]/80 dark:border-slate-800">
        <div className="w-9 h-9 rounded-xl bg-[#0B5CAB]/10 flex items-center justify-center">
          <TypeIcon className="w-4 h-4 text-[#0B5CAB]" aria-hidden />
        </div>
        <div>
          <p className="text-[12px] text-[#667085]">Transaction Type</p>
