    ...
    <div className="flex items-center justify-between gap-2">
      <div className="flex items-center gap-1 min-w-0 flex-1">
        ...
        <div className="min-w-0">
          <h1 className="text-[17px] font-semibold text-slate-900 dark:text-white">Statements</h1>
      ...
      >
        <Filter className="w-4.5 h-4.5 text-slate-500 dark:text-slate-400" />
      </button>
    </div>
    {lastUpdated && (
      <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-2 ml-9 flex items-center gap-1">
