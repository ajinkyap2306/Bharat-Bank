    ...
    <div className="px-4">
      <div className="flex gap-3 overflow-x-auto no-scrollbar rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-3 shadow-sm">
        <div className="shrink-0 min-w-20">
          <p className="text-[11px] text-slate-500 dark:text-slate-400">Credits</p>
          <p className="text-[15px] font-semibold text-slate-900 dark:text-white mt-0.5">{statement.creditCount}</p>
        </div>
        <div className="shrink-0 min-w-20">
          <p className="text-[11px] text-slate-500 dark:text-slate-400">Debits</p>
          <p className="text-[15px] font-semibold text-slate-900 dark:text-white mt-0.5">{statement.debitCount}</p>
        </div>
        <div className="shrink-0 min-w-25">
          <p className="text-[11px] text-slate-500 dark:text-slate-400">Net Movement</p>
          <p className={`text-[15px] font-semibold tabular-nums mt-0.5 ${statement.netMovement >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-[#DC2626]'}`}>
            {showBalances
