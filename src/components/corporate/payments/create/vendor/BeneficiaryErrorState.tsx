...
export const BeneficiaryErrorState: React.FC<BeneficiaryErrorStateProps> = ({
  ...
  <section className="px-4 py-8 text-center" aria-labelledby="beneficiary-error-title">
    ...
    <h2 id="beneficiary-error-title" className="text-[16px] font-semibold text-slate-900 dark:text-white">
    ...
    <button
      type="button"
      onClick={onRetry}
      className="mt-5 inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-congress-blue-700 text-white text-[14px] font-semibold min-h-12"
    >
