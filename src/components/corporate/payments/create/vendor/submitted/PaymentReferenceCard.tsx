...
export const PaymentReferenceCard: React.FC<PaymentReferenceCardProps> = ({
  ...
  >
    <p id="payment-id-label" className="text-[12px] font-medium text-[#667085] uppercase tracking-wide">
      Payment ID
    </p>
    <div className="flex items-center justify-between gap-3 mt-2">
      <p className="text-[15px] font-semibold text-[#111827] dark:text-white font-mono tracking-tight break-all">
        {paymentId}
      </p>
