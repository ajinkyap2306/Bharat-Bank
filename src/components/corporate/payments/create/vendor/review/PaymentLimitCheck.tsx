...
export const PaymentLimitCheck: React.FC<PaymentLimitCheckProps> = ({
  ...
  <section className="px-4" aria-labelledby="payment-limit-heading">
    ...
    >
      <h2 id="payment-limit-heading" className="text-[15px] font-semibold text-[#111827] dark:text-white mb-3">
        Payment Limit
      </h2>
      ...
      <p
        className={`mt-3 text-[13px] font-semibold ${withinLimit ? 'text-[#16A34A]' : 'text-[#DC2626]'}`}
        role="status"
      >
