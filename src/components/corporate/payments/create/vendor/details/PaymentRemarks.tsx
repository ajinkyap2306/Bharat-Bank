...
export const PaymentRemarks: React.FC<PaymentRemarksProps> = ({ value, onChange }) => (
  <section className="px-4" aria-labelledby="payment-remarks-label">
    <div className="rounded-2xl bg-white dark:bg-slate-900 border border-[#E4E7EC] dark:border-slate-800 p-4 shadow-sm">
      <label id="payment-remarks-label" htmlFor="payment-remarks" className="text-[14px] font-semibold text-[#111827] dark:text-white">
        Remarks
      </label>
      <textarea
        id="payment-remarks"
        ...
        maxLength={250}
        rows={3}
        className="mt-2 w-full text-[14px] text-[#111827] dark:text-white bg-transparent outline-none resize-none placeholder:text-[#667085] min-h-[88px]"
      />
      <p className="text-[12px] text-[#667085] mt-2">
        Internal note for your corporate records.
      </p>
      <p className="text-[11px] text-[#667085] text-right">{value.length}/250</p>
    </div>
  </section>
);
