  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div className="px-4 py-3 safe-top border-b border-slate-200 dark:border-slate-800 flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={onClose}
              className="w-11 h-11 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center justify-center"
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {query.trim() && results.length === 0 && (
              <p className="text-[13px] text-slate-500 dark:text-slate-400 text-center py-8">No payments found</p>
            )}
            <div className="space-y-2">
              {results.map((item) => (
                <button
                  ...
                  className="w-full p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-left min-h-16"
                >
