...
export const SourceAccountCard: React.FC<SourceAccountCardProps> = ({
  ...
  <PayCard className="p-4">
    <h3 className="text-[13px] font-semibold text-slate-900 dark:text-white mb-3">Paid From</h3>
    ...
    <dl className="mt-3 space-y-2">
      <div className="flex justify-between text-[13px]">
        ...
        <dd className="font-medium text-slate-900 dark:text-white text-right max-w-[60%]">
          {account.companyName}
        </dd>
      </div>
