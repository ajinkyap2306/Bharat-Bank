    ...
    <div className="py-4 space-y-4">
      ...
      <ProfileCard className="divide-y divide-slate-200 dark:divide-slate-800 dark:divide-slate-800">
        {[
          ...
          <div key={id} className="px-4 py-3.5 flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-congress-blue-50 dark:bg-congress-blue-950/40 flex items-center justify-center">
            ...
            <button
              ...
              className={`w-11 h-6 rounded-full p-0.5 transition-colors ${
                value ? 'bg-congress-blue-700' : 'bg-slate-300 dark:bg-slate-600'
              }`}
            >
              <span
        ...
        <button
          ...
          className="w-full px-4 py-3.5 flex items-center gap-3 text-left min-h-12 active:bg-slate-50 dark:active:bg-slate-800/50"
        >
          <div className="w-9 h-9 rounded-lg bg-congress-blue-50 dark:bg-congress-blue-950/40 flex items-center justify-center">
            <KeyRound className="w-4.5 h-4.5 text-congress-blue-700 dark:text-congress-blue-400" aria-hidden />
          </div>
          <span className="text-[14px] font-medium text-slate-900 dark:text-white">Change MPIN</span>
        </button>
        <button
          type="button"
          onClick={() =>
        ...
        >
          <div className="w-9 h-9 rounded-lg bg-congress-blue-50 dark:bg-congress-blue-950/40 flex items-center justify-center">
            <MonitorSmartphone className="w-4.5 h-4.5 text-congress-blue-700 dark:text-congress-blue-400" aria-hidden />
          </div>
          <span className="text-[14px] font-medium text-slate-900 dark:text-white">Manage Devices</span>
        </button>
        <button
          type="button"
          onClick={() =>
        ...
        >
          <div className="w-9 h-9 rounded-lg bg-congress-blue-50 dark:bg-congress-blue-950/40 flex items-center justify-center">
            <Shield className="w-4.5 h-4.5 text-congress-blue-700 dark:text-congress-blue-400" aria-hidden />
          </div>
          <span className="text-[14px] font-medium text-slate-900 dark:text-white">Active Sessions</span>
        </button>
      </ProfileCard>
    </div>
  );
