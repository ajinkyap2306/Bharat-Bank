      ...
      <ProfileCard className="divide-y divide-slate-200 dark:divide-slate-800 dark:divide-slate-800">
        {items.map(({ id, label, icon: Icon, action }) => (
          <button
            ...
            type="button"
            onClick={action}
            className="w-full px-4 py-3.5 flex items-center gap-3 text-left min-h-12 active:bg-slate-50 dark:active:bg-slate-800/50 dark:active:bg-slate-800/50"
          >
            <div className="w-9 h-9 rounded-lg bg-congress-blue-50 dark:bg-congress-blue-950/40 flex items-center justify-center shrink-0">
              <Icon className="w-4.5 h-4.5 text-congress-blue-700 dark:text-congress-blue-400" aria-hidden />
            </div>
      ...
      {showRm && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/50">
          ...
          >
            ...
            <p className="text-[13px] text-slate-500 dark:text-slate-400 mt-1">{company.name}</p>
            <div className="mt-4 p-3 rounded-xl bg-slate-50 dark:bg-slate-950 dark:bg-slate-800">
              <p className="text-[14px] font-semibold text-slate-900 dark:text-white">
                {company.relationshipManager}
              </p>
              <p className="text-[13px] font-mono text-congress-blue-700 dark:text-congress-blue-400 mt-1">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              <button
                ...
                className="py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 text-sm font-semibold text-slate-500 dark:text-slate-400 min-h-11"
              >
                Close
              </button>
              <button
                ...
                className="py-2.5 rounded-xl bg-congress-blue-700 text-white text-sm font-semibold min-h-11"
              >
                Request Callback
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/50">
          ...
          >
            ...
            <textarea
              ...
              className="mt-4 w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 py-2.5 text-sm text-slate-900 dark:text-white resize-none"
            />
            <div className="mt-4 grid grid-cols-2 gap-2">
              <button
                type="button"
