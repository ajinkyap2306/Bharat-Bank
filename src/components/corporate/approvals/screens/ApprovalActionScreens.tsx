...
export const ApproveConfirmScreen: React.FC<{
  ...
  <div className="-mx-3 bg-[#F7F9FC] dark:bg-slate-950 min-h-full pb-24">
    ...
    <div className="px-3">
      <p className="text-sm font-bold text-[#111827] dark:text-white mb-3">Approve this request?</p>
  ...
  return (
    <div className="-mx-3 bg-[#F7F9FC] dark:bg-slate-950 min-h-full pb-24">
      ...
      <ApprovalCard className="p-4 mx-3 space-y-4">
        ...
        {method === 'biometric' && (
          <button type="button" className="w-full py-4 rounded-xl border border-dashed text-sm font-bold text-[#0B5CAB] min-h-11">
...
export const ApproveSuccessScreen: React.FC<{
  ...
  return (
    <div className="-mx-3 bg-[#F7F9FC] dark:bg-slate-950 min-h-full flex flex-col items-center p-6 text-center pb-24">
      ...
      <h2 className="text-lg font-bold text-[#111827] dark:text-white">Request Approved</h2>
      ...
      <p className="text-sm font-bold text-[#667085] mt-4">
        ...
        {REJECTION_REASONS.map((r) => (
          <button
            ...
            className={`w-full p-3 rounded-xl text-left text-sm font-medium min-h-11 ${
              reason === r ? 'bg-[#0B5CAB]/10 border-2 border-[#0B5CAB]' : 'bg-white border border-slate-200'
            }`}
          >
            {r}
          </button>
...
export const RejectConfirmScreen: React.FC<{
  ...
  <div className="-mx-3 bg-[#F7F9FC] dark:bg-slate-950 min-h-full pb-24">
    ...
    <div className="px-3">
      <p className="text-sm font-bold text-[#111827] dark:text-white mb-3">Reject this request?</p>
      <ApprovalCard className="p-4">
        <ReviewRow label="Request ID" value={request.requestId} />
        <ReviewRow label="Type" value={request.requestType} />
        {request.amount !== undefined && request.amount > 0 && (
...
export const RejectSuccessScreen: React.FC<{
  ...
  <div className="-mx-3 bg-[#F7F9FC] dark:bg-slate-950 min-h-full flex flex-col items-center p-6 text-center pb-24">
    ...
    <h2 className="text-lg font-bold text-[#111827] dark:text-white">Request Rejected</h2>
    <ApprovalCard className="p-4 mt-4 w-full text-left">
      <ReviewRow label="Request ID" value={request.requestId} />
    ...
    <p className="text-xs text-[#667085] mt-4">Return to Maker for correction</p>
    <StickyApprovalCTA label="Done" onClick={onDone} />
  </div>
);
...
export const ChangesRequestScreen: React.FC<{
  ...
  return (
    <div className="-mx-3 bg-[#F7F9FC] dark:bg-slate-950 min-h-full pb-24">
      ...
      <div className="px-3">
        <p className="text-sm text-[#667085] mb-3">Enter comments for the maker</p>
        <textarea
          value={comments}
...
export const ChangesSuccessScreen: React.FC<{
  ...
  <div className="-mx-3 bg-[#F7F9FC] dark:bg-slate-950 min-h-full flex flex-col items-center p-6 text-center pb-24">
    <h2 className="text-lg font-bold text-[#111827] dark:text-white">Changes Requested</h2>
    <ApprovalCard className="p-4 mt-4 w-full text-left">
      <ReviewRow label="Request ID" value={request.requestId} />
