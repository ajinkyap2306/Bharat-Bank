...
export const ApprovalsHeader: React.FC<ApprovalsHeaderProps> = ({
  ...
  <header className="px-4 pt-3 pb-2 safe-top">
    <div className="flex items-center justify-between gap-3 max-w-[430px] mx-auto">
      <h1 className="text-lg font-bold text-[#111827] dark:text-white tracking-tight">Approvals</h1>
      <div className="flex items-center gap-1.5 shrink-0">
        ...
        >
          ...
          {filterCount > 0 && (
            <span className="absolute -top-1 -right-1 min-w-[16px] h-4 px-1 rounded-full bg-[#0B5CAB] text-white text-[9px] font-bold flex items-center justify-center">
              {filterCount}
            </span>
          )}
        </button>
