  ...
  <div className="fixed bottom-0 left-0 right-0 z-30 p-3 pb-safe bg-slate-50/95 dark:bg-slate-950/95 dark:bg-slate-950/95 backdrop-blur-md border-t border-slate-200 dark:border-slate-800">
    <div className="max-w-[430px] mx-auto space-y-2">
      <button
        ...
        className="w-full py-3.5 rounded-2xl bg-congress-blue-700 text-white text-[15px] font-semibold min-h-12 disabled:opacity-50 flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-congress-blue-500 focus-visible:ring-offset-2"
      >
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 py-3.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-congress-blue-700 dark:text-congress-blue-400 text-[14px] font-semibold min-h-11 disabled:opacity-50"
        >
          Return for Changes
        </button>
        <button
