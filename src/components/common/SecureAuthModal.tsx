          ...
          >
            <div className="p-6 text-center space-y-6">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500">Enter your 6-digit Secure PIN to authorize</p>
              </div>
            ...
            {isProcessing && (
              <div className="absolute inset-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm flex flex-col items-center justify-center space-y-4">
                ...
                <p className="text-sm font-bold text-slate-900 dark:text-white tracking-widest uppercase">Verifying PIN</p>
              </div>
            )}
          </motion.div>
        </div>
